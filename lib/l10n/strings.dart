...
class AppStrings {
  static final Map<String, Map<String, String>> map = {
    // عام / التطبيق
    'app_title': {
      'ar': 'موسوعة الحاسبات الشاملة',
      'en': 'Master Calculator Hub'
    },
    ...
    'drawer_background': {
      'ar': 'تغيير الخلفية بألوان انتقائية',
    ...
    'watch_ad_to_unlock': {
      'ar': 'شاهد إعلانًا قصيرًا لفتح هذا الثيم نهائيًا',
      'en': 'Watch a short ad to unlock this theme forever'
    },
    'ad_not_ready_try_later': {
      'ar': 'الإعلان غير جاهز الآن، حاول بعد قليل',
      'en': 'Ad not ready yet, please try again shortly'
    },
    'unlocked_now': {
      'ar': '🎉 تم فتح الثيم المميز بنجاح!',
      'en': '🎉 Premium theme unlocked successfully!'
    },
    'no_sessions': {
      'ar': 'لا توجد جلسات محفوظة حتى الآن',
      'en': 'No saved sessions yet'
    },
    ...
    'notes_hint': {
      'ar': 'اكتب ملاحظتك عن هذا الحساب هنا...',
      'en': 'Write your note about this calculation here...'
    },
    'notes_saved': {
    ...
    'notes_empty_error': {
      'ar': 'الرجاء كتابة نص قبل الحفظ',
      'en': 'Please write some text before saving'
    },

    // الشاشة الرئيسية (القائمة)
    'landing_subtitle': {
      'ar': 'كل حاسباتك في مكان واحد',
      'en': 'All your calculators in one place'
    },
    'nav_scientific': {
      'ar': 'الحاسبة العلمية الشاملة',
      'en': 'Scientific Calculator'
    },
    'copyright_text': {
    ...
    'about_desc': {
      'ar':
          'تطبيق شامل لكل ما تحتاجه من حاسبات مالية، صحية، هندسية وتحويلات فورية للعملات والوحدات — بواجهة سريعة وأنيقة تعمل بدون إنترنت (باستثناء تحديث أسعار العملات اللحظية).',
      'en':
          'An all-in-one hub for finance, health, scientific and instant currency & unit conversion calculators — fast, elegant, and works offline (except live currency updates).'
    },
    'about_developer': {
      'ar':
      ...
      'en':
          'Developed by HASSADI to provide a smooth, professional experience for everyday calculations and conversions with high accuracy.'
    },
    ...
    'currency_category': {
      'ar': 'تحويل العملات (أسعار لحظية مباشرة)',
      'en': 'Currency (live exchange rates)'
    },
    'live_rate_note': {
      'ar': 'الأسعار محدّثة لحظيًا من مصدر عالمي موثوق',
      'en': 'Rates updated live from a trusted global source'
    },
    'last_updated': {'ar': 'آخر تحديث', 'en': 'Last updated'},
    'refresh_rates': {'ar': 'تحديث الأسعار الآن', 'en': 'Refresh rates now'},
    'offline_rates': {
      'ar': 'تعذر الاتصال — تُعرض آخر أسعار محفوظة',
      'en': 'Offline — showing last saved rates'
    },
    'fetching_rates': {
      'ar': 'جاري جلب أسعار الصرف اللحظية...',
    ...
    'fin_unit_cost': {
      'ar': 'تكلفة الوحدة المتغيرة',
      'en': 'Variable Cost per Unit'
    },
    'fin_sub_result': {
      'ar': 'الناتج الفرعي / الزيادة',
      'en': 'Sub-result / Increase'
    },
    ...
    'fin_breakeven_units': {
      'ar': 'عدد الوحدات لتحقيق التعادل',
      'en': 'Units for break-even'
    },
    'fin_goal_amount': {'ar': 'المبلغ المستهدف', 'en': 'Target Amount'},
    'fin_monthly_saving': {
      'ar': 'الادخار الشهري المطلوب',
      'en': 'Required Monthly Saving'
    },

    // تبويب الصحة
    'h_bmi': {'ar': 'مؤشر كتلة الجسم (BMI)', 'en': 'BMI Calculator'},
    'h_hba1c': {
      'ar': 'متوسط السكر التراكمي (HbA1c)',
      'en': 'HbA1c Estimated Glucose'
    },
    'h_bmr': {
    ...
    'h_heart_rate': {
      'ar': 'المعدل المستهدف لنبضات القلب',
      'en': 'Target Heart Rate Zones'
    },
    'h_pregnancy': {
      'ar': 'حاسبة موعد الولادة المتوقع',
    ...
    'h_hip': {
      'ar': 'محيط الورك (سم) - للإناث فقط',
      'en': 'Hip (cm) - females only'
    },
    'h_hba1c_input': {'ar': 'نسبة السكر التراكمي (%)', 'en': 'HbA1c (%)'},
    'h_lmp': {
      'ar': 'أول يوم من آخر دورة شهرية (كم يومًا مضى)',
      'en': 'Days since first day of last period'
    },
    ...
    'h_weight_loss_label': {
      'ar': 'فقدان الوزن (عجز 20%)',
      'en': 'Weight loss (20% deficit)'
    },
    'h_weight_gain_label': {
      'ar': 'زيادة الوزن (فائض 15%)',
      'en': 'Weight gain (15% surplus)'
    },
    'liters_per_day': {'ar': 'لتر/يوم', 'en': 'liters/day'},
    'h_avg_glucose': {
      'ar': 'متوسط السكر التقديري',
      'en': 'Estimated Average Glucose'
    },
    'h_max_hr': {'ar': 'أقصى معدل نبض', 'en': 'Maximum Heart Rate'},
    'bpm_unit': {'ar': 'نبضة/دقيقة', 'en': 'bpm'},
    'h_fat_burn_zone': {
      'ar': 'منطقة حرق الدهون (50-65%)',
      'en': 'Fat Burn Zone (50-65%)'
    },
    'h_cardio_zone': {
      'ar': 'منطقة اللياقة القلبية (65-85%)',
      'en': 'Cardio Zone (65-85%)'
    },
    'h_current_week': {
      'ar': 'الأسبوع الحالي تقريبًا',
      'en': 'Approx. Current Week'
    },
    'week_unit': {'ar': 'أسبوع', 'en': 'week'},
    'h_days_remaining': {
      'ar': 'الأيام المتبقية تقريبًا للولادة',
      'en': 'Approx. Days Until Due Date'
    },
    ...
    'c_discount': {
      'ar': 'حاسبة الخصم والنسبة (Discount)',
      'en': 'Discount Calculator'
    },
    'c_percentage': {
      'ar': 'حاسبة النسب المئوية البسيطة',
      'en': 'Simple Percentage'
    },
    ...
    'c_original_value': {
      'ar': 'السعر الأصلي أو القيمة',
      'en': 'Original Price / Value'
    },
    ...
    'c_total_days_since_birth': {
      'ar': 'إجمالي الأيام منذ الميلاد',
      'en': 'Total days since birth'
    },
    ...
    'share_app_message': {
      'ar':
          'جرّب تطبيق موسوعة الحاسبات الشاملة — موسوعة حاسبات مالية وصحية وهندسية وتحويلات لحظية شاملة!',
      'en':
          'Try Master Calculator Hub — a full suite of finance, health, scientific and instant conversion calculators!'
    },
